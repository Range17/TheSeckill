...
import static org.seckill.dao.SeckillDao.*;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    private final  String salt="hhhshhfvjbnbbnkcvv";
    @Autowired
...
//        因为redis是放在内存内的，如果不用redis的话是去数据库访问，即硬盘，其访问速度比内存低多了
//        做了数据缓存，降低访问量
